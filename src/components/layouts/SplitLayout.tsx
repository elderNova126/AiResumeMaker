...
const SplitLayout: React.FC<SplitLayoutProps> = ({
  ...
  const renderSection = (
    ...
    <div className="flex items-center space-x-2">
      ...
      <AutoResizeField
        value={value}
        className="flex-1 bg-transparent border-b border-transparent hover:border-gray-200 focus:border-emerald-500 focus:outline-none"
    ...
    <div className="bg-white shadow-lg mx-auto mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-3 w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] p-4 sm:p-8">
      ...
      <div className="col-span-1 md:col-span-3 p-8 flex items-start space-x-8 border-b">
        ...
        <div>
          <AutoResizeField
            value="John Doe"
            className="text-3xl sm:text-4xl font-bold w-full mb-2"
            style={{ color: themeColor }}
            placeholder="Your Name"
          />
          <AutoResizeField
            value="SENIOR SOFTWARE ENGINEER"
            className="text-lg sm:text-xl text-gray-600 w-full bg-transparent border-b border-transparent hover:border-gray-200 focus:border-emerald-500 focus:outline-none"
      ...
      <div className="col-span-1 bg-gray-50 p-8">
        <h2 className="text-lg sm:text-xl font-bold mb-4" style={{ color: themeColor }}>
          PERSONAL DETAILS
        </h2>
        ...
        {visibleSections.includes("skills") && (
          <div className="mt-8">
            ...
            <AutoResizeField
              ...
              className="w-full p-2 text-sm bg-transparent rounded-md"
        ...
        {visibleSections.includes("languages") && (
          <div className="mt-8">
            ...
            <AutoResizeField
              ...
              className="w-full p-2 text-sm bg-transparent border rounded-md focus:border-emerald-500 focus:outline-none"
      ...
      <div className="col-span-1 md:col-span-2 p-8">
        {visibleSections.includes("about") && (
          <div className="mb-8">
            <h2 className="text-xl sm:text-2xl font-bold mb-4" style={{ color: themeColor }}>
              ABOUT ME
            </h2>
            <AutoResizeField
              type="textarea"
              value="Highly skilled and experienced software engineer with a proven track record in developing scalable applications and leading development teams. Passionate about creating efficient solutions and mentoring junior developers."
