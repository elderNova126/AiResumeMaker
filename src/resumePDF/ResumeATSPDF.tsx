...
const ResumeATSPDF: React.FC<ResumeATSPDFProps> = ({
  themeColor,
  name,
  role,
  email,
                ...
                {experiences.map((experience, index) => (
                  <View key={index}>
                    ...
                    <Text style={styles.text}> 
                      ...
                      <Text style={styles.companyDetails}> |  {experience.company}</Text>
                    </Text> 
                    <Text style={styles.text}> 
