...
const Header: React.FC<HeaderProps> = ({
  ...
  const handlePrint = (elementId) => {
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700&amp;family=Archivo+Narrow:wght@400;500;600;700&amp;family=Syne:wght@400;500;600;700&amp;family=DM+Serif+Display&amp;family=DM+Sans:wght@400;500;600;700&amp;family=Poppins:wght@400;500;600;700&amp;family=Rubik:wght@400;500;600;700&amp;family=Fira+Sans:wght@400;500;600;700&amp;family=Josefin+Sans:wght@400;500;600;700&amp;family=Roboto+Mono:wght@400;500;600;700&amp;family=Fjalla+One&amp;family=Inter:wght@400;500;600;700&amp;display=swap" rel="stylesheet">
    <title>ResumeMaker</title>
  <style type="text/css" data-vite-dev-id="C:/Users/h/Documents/AiResumeMaker/src/index.css">*, ::before, ::after {
	...
	*/
	...
	/* Base styles for auto-resize fields */
	textarea {
	  min-height: 1.5em;
	  overflow: hidden;
	  resize: none;
	...
	@media print {
	  ...
	  .print\:\!scale-100 {
		...
		transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y)) !important;
		  ...
		  cursor: -webkit-grab;
		  cursor: grab;
		 }  </style><style type="text/css" data-rbd-always="1"> [data-rbd-drag-handle-context-id="1"] { 
			  -webkit-touch-callout: none;
			  -webkit-tap-highlight-color: rgba(0,0,0,0);
			  touch-action: manipulation;
		  ...
		  cursor: -webkit-grab;
		  cursor: grab;
		 }  </style><style type="text/css" data-rbd-always="2"> [data-rbd-drag-handle-context-id="2"] { 
			  -webkit-touch-callout: none;
			  -webkit-tap-highlight-color: rgba(0,0,0,0);
			  touch-action: manipulation;
			 } [data-rbd-droppable-context-id="2"] { overflow-anchor: none; } </style><style type="text/css" data-rbd-dynamic="2"> [data-rbd-drag-handle-context-id="2"] { 
		  cursor: -webkit-grab;
		  cursor: grab;
		 }  </style><style type="text/css" data-rbd-always="3"> [data-rbd-drag-handle-context-id="3"] { 
			  -webkit-touch-callout: none;
			  -webkit-tap-highlight-color: rgba(0,0,0,0);
			  touch-action: manipulation;
			 } [data-rbd-droppable-context-id="3"] { overflow-anchor: none; } </style><style type="text/css" data-rbd-dynamic="3"> [data-rbd-drag-handle-context-id="3"] { 
		  cursor: -webkit-grab;
		  cursor: grab;
      ...
      <header className="w-full bg-white shadow-sm py-4 px-6 fixed top-0 z-50  print:hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-end space-x-3">
            ...
            <button
            onClick={() => handlePrint('resume-template')}
